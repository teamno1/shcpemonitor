var Drag={
	...
	"drag":function(e){
		...
		if(currentLeft < 0){//防止超出边界
			currentLeft = 0
		}else if(currentLeft > document.documentElement.clientWidth - handle.offsetWidth){
			currentLeft = document.documentElement.clientWidth - handle.offsetWidth
		}
		 if(currentTop < 0){
			currentTop = 0
		}else if(currentTop > document.documentElement.clientHeight - handle.offsetHeight){
			currentTop = document.documentElement.clientHeight - handle.offsetHeight
		}
