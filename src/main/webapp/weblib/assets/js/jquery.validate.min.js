...
$.extend( $.validator, {
	...
	prototype: {
		...
		defaultShowErrors: function() {
			var i, elements, error,firstElement;
			for ( i = 0; this.errorList[ i ]; i++ ) {
				...
				if( i == 0){
					firstElement = this.idOrName(error.element);
				}
			...
			if( firstElement != undefined ){
				var elementTop=$("#" + firstElement).offset().top;
		...
		showLabel: function( element, message ) {
			...
			message = $("#"+elementID).attr("tips") == undefined ? message : $("#"+elementID).attr("tips");
			if(element.tagName == 'SELECT'){
				...
				//$("#si2d" + elementID).next().children("#select2-" + elementID + "-container").tips({
				$("#s2id_" + elementID).tips({
					side: 3,
			        msg: message,
			        bg: '#AE81FF',
			        time: 1
