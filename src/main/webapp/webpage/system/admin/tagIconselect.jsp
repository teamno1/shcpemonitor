...
<head>
	...
	<link rel="stylesheet" href="webpage/system/menu/css/bootstrap.min.css"/>
 	<link rel="stylesheet" href="weblib/assets/css/font-awesome.min.css">
    <style type="text/css">
    	.page-header {clear:both;margin:0 20px;padding-top:5px;}
...
<input type="hidden" id="icon" value="${value}" />
	<div id="icons">
	    <h3 class="page-header"> Web 应用的图标</h3>
	    <ul class="the-icons">
	    ...
	    <h3 class="page-header">文本编辑器图标</h3>
	    <ul class="the-icons">
	    ...
	    <h3 class="page-header">指示方向的图标</h3>
	    <ul class="the-icons">
	    ...
	    <h3 class="page-header">视频播放器图标</h3>
	    <ul class="the-icons">
...
<script src="weblib/assets/js/jquery-1.8.3.min.js"></script>
<script src="weblib/assets/js/bootstrap.min.js"></script>
<script type="text/javascript" src="weblib/assets/js/select2.min.js"></script><%--选择框--%>
<script type="text/javascript" src="plugins/jquery-jbox/2.3/jquery.jBox-2.3.min.js"></script>
