...
<div id="pageContent" class="pageFormContent" style="margin-right:30px;line-height:35px;">
	<a class="btn btn-minier btn-white" href="javascript:submitForm('first',pageForm)" id="first" style="width: 50px;line-height: 22px;margin-top:-4px;padding:0px;" type="button">首页</a> 
	<a class="btn btn-minier btn-white" href="javascript:submitForm('previous',pageForm)" id="previous" style="line-height: 22px; margin: 0px 5px;padding:0px; width: 60px;margin-top:-4px;" type="button">上一页</a> 
	<a class="btn btn-minier btn-white" href="javascript:submitForm('next',pageForm)" id="next" style="line-height: 22px; width: 60px;margin-top:-4px;padding:0px;" type="button">下一页</a>  
	<a class="btn btn-minier btn-white" href="javascript:submitForm('last',pageForm)" id="last" style="line-height: 22px;  margin: 0px 35px 0px 5px;padding:0px;width: 50px;margin-top:-4px;" type="button">末页</a>
