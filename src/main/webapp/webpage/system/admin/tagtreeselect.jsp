	...
	<link href="static/jquery-ztree/3.5.12/css/zTreeStyle/zTreeStyle.min.css" rel="stylesheet" type="text/css"/>
		<style type="text/css">
			...
			#tagSelectSearch{
				...
				margin-left:-4px!important;color:#fff!important;font-size:14px!important;line-height:32px;border-radius:0 3px 3px 0;
			}
		</style>
...
<body>
	<div class="input-group" style="padding:5px">
		<input  id="key" name="key" type="text" class="form-control search-query" placeholder="请输入关键字查询" style="border-radius:3px 0 0 3px;"/>
