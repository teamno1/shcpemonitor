...
public class PreparePaginationInterceptor extends BaseInterceptor {
    ...
    public Object intercept(Invocation ivk) throws Throwable {
        if (ivk.getTarget().getClass().isAssignableFrom(RoutingStatementHandler.class)) {
            ...
            final BaseStatementHandler delegate = (BaseStatementHandler) ReflectionUtil.getFieldValue(statementHandler, DELEGATE);
            final MappedStatement mappedStatement = (MappedStatement) ReflectionUtil.getFieldValue(delegate, MAPPED_STATEMENT);
...
//            if (StringUtils.indexOfIgnoreCase(mappedStatement.getId(), _SQL_PATTERN) != -1) {
                ...
                if (parameterObject == null) {
                    ...
                    //将分页sql语句反射回BoundSql.
                    ReflectionUtil.setFieldValue(boundSql, "sql", pagingSql);
                }
